...
| Sprint 1.4 | 🔄 In Progress | Resolve the 16 backend Ruff diagnostics: import organization, mutable class attributes, unused seed-command unpacking, and generated migration lint scope |
