...
| Sprint 3.3 | 🔄 In Progress | Correct docs config paths to `client/biome.json` and `backend/pyproject.toml`, add 20–2000 ms random API latency via apiClient, and refactor `index.css` with design-system tokens plus inline-style removal |
